...
<h1 align="center" style="background-color:#D7DBDD; color:#384EDD;">  Harsiddhi Mata Temple</h1>
<h2> Shri Harsiddhi Maa Temple of Ujjain Madhya Padesh is one of the ancient places of India
 and it is the 13th Shaktipeeth among the 51 Shaktipeeths of Mata Sati. From the pages
  of history it is revealed that Maa Harsiddhi devi was the deity, the supreme being
   of Samrat Vikramaditya and known by the name ‘Mangalchandiki’ in ancient time.</h2>

<h1 style="color:yellow">For Special Pooja- </h1>
</font>
<h3> Priest Name - Pt.Tondon Baba   
Contact number - 8871577736
 </h3>
<h3>Special Pooja -  <br/>
1)Durga Chalisa Paath  &nbsp;&nbsp;&nbsp;<spring:url value="/temple/booknow" var="booknowURL" />
				<a href="${booknowURL}" role="button"><font color="#8E44AD">Book Now </font></a>
<br>
2)Mataji Aarti  &nbsp;&nbsp;&nbsp;<spring:url value="/temple/booknow" var="booknowURL" />
				<a href="${booknowURL}" role="button"><font color="#8E44AD">Book Now </font></a>
<br> 
</h3>
</div>
