...
<div class="container">
		<spring:url value="/temple/sub" var="saveURL" />
		<h2>Book Now</h2>		
		
		<form:form modelAttribute="bookNow" method="POST" action="${saveURL }" cssClass="form">
			...
			<div class="form-group">
				...
				<form:input type="text" path="contact" cssClass="form-control" id="contact" />
			</div>
			
			<div class="form-group">
			<label for = "Amount">Amount</label>
			<form:input type ='text' path='Amount' cssClass="form-control" id='Amount'/>
			</div>
			<p id="bookmsg"></p>
			
			<button type="submit"  onsubmit="messagebox();"  class="btn btn-primary">Book</button>
		</form:form>
	</div>
...
function messagebox()
{
	 ...
	 var book;
	  if (confirm("Press a button!")) {
	    book = "Your Booking is completed!!
		    You can check your reciept in Reciept Menu";
	  } else {
	    book = "Unable to book Please fill correct information!";
	  }
	  document.getElementById("bookmsg").innerHTML = book;
