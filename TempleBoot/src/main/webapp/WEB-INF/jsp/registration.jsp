...
<div>
<form  method="post" action="user.jsp" name="Registration" onsubmit="return validate();">
<input type="hidden" name="action" value="registration" />

<h3>NAME &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="name"></h3>
<br>
<h3>USERID &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="id"></h3>
<br> 
<h3>GENDER &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="gender" value="male">MALE<input type="radio" name="gender" value="female">FEMALE</h3>
<br>
<h3>PASSWORD &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="password"></h3>
<br>
<h3>CONFORM PASSWORD &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="cpassword"></h3>
<br>
<h3>CONTACT &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="contact"></h3>
<br>
<h3>EMAILID &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="email"></h3>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
