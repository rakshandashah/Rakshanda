...
<!-- Show Other Pages are here -->
	<div class="container">
		<spring:url value="/temple/sav" var="saveURL" />
		<h2>Donation Page</h2>
		<form:form modelAttribute="donateForm" method="POST" action="${saveURL }" cssClass="form">
			...
			<div class="form-group">
				...
				<form:input  type ='text' path="phone" cssClass="form-control" id="phone" />
			</div>
			<div class="form-group">
