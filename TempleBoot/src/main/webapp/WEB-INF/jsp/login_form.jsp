...
<div align="center" style="background-color:">
		...
		<spring:url value="/temple/check" var="saveURL" />
		
		<form:form modelAttribute="logins" method="POST" action="${saveURL }" cssClass="form">	
	<input type="hidden" name="action" value="login" />
		
<h1 style="background-color:" align="center">Login form</h1>
User Name &nbsp; &nbsp;<form:input path="name" type ='text' cssClass="form-control" id="name" />
<br>
<br>
Password  &nbsp; &nbsp;<form:input type ='text' path='password' cssClass="form-control" id='password'/>
<br>
<br>
...
<spring:url value="/temple/add" var="regiURL" />
				<a class="nav-item" href="${regiURL }" role="button">Register</a>
</div>
