...
<div align="center" style="background-color:" class="bg">
<form method="POST" action="UserHandler" name="TempleList">
	<input type="hidden" name="action" value="TempleList" />
		
<h1 style="background-color:" align="center">Temple List</h1>
...
<br>
<br>
<label for="PanditjiName">Panditji Name</label>
&nbsp; &nbsp;
<br>
<br>
