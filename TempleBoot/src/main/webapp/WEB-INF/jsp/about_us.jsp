...
<h1> Hello Spriritual Peeps!!</h1> 

<h2> We are here to make your Spirituality level up!
SpiritualMonk.com have almost all the temples covered for the various activities like (Special Pooja,Donation,Spiritual books, Astrologer details, Hotels near Temples) on a single plateform.
You just have to click a button to book any of the activity provided by us.
                                        We are authorized with the administration of listed temple.
So you can take the advantage of the services offered by any of these temples.
We provide priests specially for marriage purpose, spiritual books list,hotels information nearby temple.
Information about the best Astrologers in the city,Donation link for every temple.

Our Aim is to provide all the spiritual services on a single plateform ie. SpiritualMonk.com
</h2>

<h2>We have built this website using  Java Spring boot technology that helps us the build
the Front End using jsp pages as well as back end.For data base we have used MySql workbench software.</h2>
 
<h2> Sprituality is the best way to connect with God.</h2>
<h2> Spiritually is the key to SUCCESS!! </h2>
