...
<div class="mySlides fade">
  ...
  <img src="https://shrimathuraji.com/wp-content/uploads/2018/05/mahakaal-temple.jpg"  align="center">
  <div class="text">Mahakal</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 6</div>
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Lord_Kal_Bhairav%2C_Ujjain.jpg/1280px-Lord_Kal_Bhairav%2C_Ujjain.jpg"  align="center">
  <div class="text">Kal Bhairav</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 6</div>
  <img src="https://image3.mouthshut.com/images/Restaurant/Photo/-83381_8236.jpg"  align="center">
  <div class="text">Harsidhdhi Maa</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">4 / 6</div>
  <img src="http://media.webdunia.com/_media/hi/img/picture-gallery/thumb/photothumb/2235B_Gabi-Hanuman_2-b.jpg"  align="center">
  <div class="text">Gebi Hanumanji</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">5 / 6</div>
  <img src="https://www.newstracklive.com/uploads/jivan-mantra/Religion/Nov/26/big_thumb/gadh-kalik_56570301ba778.jpg"  align="center">
  <div class="text">Gadhkalika</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">6 / 6</div>
  <img src="https://i.ytimg.com/vi/FGIVGC9sU8M/hqdefault.jpg"  align="center">
...
<font face="Centaur" size="6">
<h1 align="center" style="background-color:#D7DBDD; color:#384EDD;">
	
Chintaman Ganesh Temple   </h1>
Chintaman Ganesh is the biggest temple of Lord Ganesha in Ujjain. 
This temple is built across the shipra river on the Fatehabad railway line,
 and is located about 7 km far south-westerly to the Ujjain town.
The temple is located now in the middle of the town's market.

The temple dates back to 11th and 12th centuries when the Paramaras ruled over Malwa.
The Ganesha idol enshrined in this temple is supposed to be swayamabhu (self manifested).
Locally, Ganesha is also referred to as Chintaman. His consorts, Ridhhi and Siddhi, flank Chintaman, the assuager of all worries.[2] The finely-carved stone pillars in the assembly hall and the white shrine define the age-old sanctity of the temple.
The temple deity Lord Ganesha is regarded as the Lord of beginnings as per the Hindu beliefs.
In the traditional times, the Lord is known as Chintaharan which literally means remover of
all worries and tensions. 

<h1 style="color:yellow">For Special Pooja- </h1>
</font>
<h3> Priest Name - Pt.Shyam Tyagi   
Contact number - 700066198</h3>
<h3>Special Pooja - 
1)Aaditya Hriday Strota  &nbsp;&nbsp;&nbsp;

	<spring:url value="/temple/booknow" var="booknowURL" />
				<a href="${booknowURL}" role="button"><font color="#8E44AD">Book Now </font></a>
