...
function showSlides() {
  ...
  setTimeout(showSlides, 2000); // Change image every 2 seconds
	...
	<div
		style="border: thick; border-color: yellow; background-color: #AED6F1;">
		<!-- Show Other Pages are here -->
		<div class="container">
			<spring:url value="/temple/save" var="saveURL" />
			<h2>User</h2>
			...
			<form:form modelAttribute="userForm" method="POST"
				...
				<div class="form-group">
					<label for="name">First Name</lable>
				...
				<div class="form-group">
					<label for="number">Phone</lable>
					<form:input type="text" path="number" cssClass="form-control"
						id="number" />
				</div>
