...
<h1 align="center" style="background-color:#D7DBDD; color:#384EDD;">  kaal bhairav Temple</h1>

<h2>The Kal Bhairav temple is a Hindu temple located in the Ujjain city of Madhya Pradesh,
 India. It is dedicated to Kal Bhairav, the guardian deity of the city.
  Located on the banks of the Shipra River, it is one of the most active temples in the city,
   visited by hundreds of devotees daily. Liquor is one of the offerings made to the temple
    deity </h2>
    
<h1 style="color:yellow">For Special Pooja- </h1>
</font>
<h3> Priest Name - Pt.ShivaNarayan Verma   
Contact number - 9982608989 </h3>
<h3>Special Pooja - <br/>
1)BhairavAashtak Pooja  &nbsp;&nbsp;&nbsp;<spring:url value="/temple/booknow" var="booknowURL" />
				<a href="${booknowURL}" role="button"><font color="#8E44AD">Book Now </font></a>
<br>
2)Bhairav Shayan Aarti  &nbsp;&nbsp;&nbsp;<spring:url value="/temple/booknow" var="booknowURL" />
				<a href="${booknowURL}" role="button"><font color="#8E44AD">Book Now </font></a>
<br> 
</h3>
</div>
