...
<a class="nav-link" href="/temple/Receipt">Receipt</a></li>
    ...
    <li> <spring:url value="/temple/media" var="homeURL" />
<a class="nav-link" href="/temple/media">Media</a></li>
...
<h1 style="color:green;backgroundp-color:blue;">
Successfully done
</h1>
<spring:url value="/temple/message" var="msgURL" />

			<form:form method="POST"
				action="${msgURL }" cssClass="form">
