...
<body bgcolor="#A9CCE3">
<h1 align="left" style="color:#FF4233;background-color:">Spiritual Monk</h1>
	<marquee style="color:#3CE672">WELCOME AT SPIRITUAL MONK</marquee>
	
	<div align = "right" style="background-color:#5555;color:#7777;">
		<form>
			<input type="text" value="search temples and puja" /> <input type="button"
				value="search" />
   ...
   <div style="background-color:#EC7063;color:#F96A4A;">
		...
		<nav class="navbar navbar-expand-sm bg-light">
			...
			<li class="nav-item">
				...
				<a class="nav-item" href="${homeURL }" role="button">Home</a>
    ...
    <li class="nav-item dropdown"> <spring:url value="/temple/home" var="homeURL" />
      ...
      <div class="dropdown-menu">
      	<a class="dropdown-item" href="#">Mahakal Temple</a>
        <a class="dropdown-item" href="#">Shani Dev Temple</a>
        <a class="dropdown-item" href="#">Gebi Hanuman Temple</a>
        <a class="dropdown-item" href="#">Harshidhi Mata Temple</a>
        <a class="dropdown-item" href="#">Kal Bhairav Temple</a>
        <a class="dropdown-item" href="#">Garkalika Mata Temple</a>
        <a class="dropdown-item" href="#">Chintaman Ganesh Temple</a>
      </div>
    </li>
...
G1mwmki_TgOhpGfhTYsIaT4OCbQRoCHWIQAvD_BwE&gclsrc=aw.ds">Hotel</a>
		...
		<li class="nav-item"> <spring:url value="/temple/home" var="homeURL" />
<a class="nav-link" href="Donate.jsp">Donate</a></li>
		<li class="nav-item"> <spring:url value="/temple/home" var="homeURL" />
<a class="nav-link" href="#">Reciept</a></li>
		<li class="nav-item"> <spring:url value="/temple/home" var="homeURL" />
...
<div style="border: thick;border-color:yellow;background-color:powderblue">
