...
<h1 align="center" style="background-color:#D7DBDD; color:#384EDD;"> Mahakaleshwar Temple </h1>

<h3> Mahakaleshwar Jyotirlinga is a Hindu temple dedicated to Lord Shiva and
 one of the twelve Jyotirlingams, shrines which are said to be the most sacred 
 abodes of Lord Shiva. It is located in the ancient city of Ujjain in the state 
 of Madhya Pradesh, India. The temple is situated on the side of the Rudra Sagar lake.
  The presiding deity, Lord Shiva in the lingam form is believed to be Swayambhu,
   deriving currents of power (Shakti) from within itself as against the other images 
   and lingams that are ritually established and invested with mantra-shakti.  </h3>


<h1 style="color:yellow">For Special Pooja- </h1>
</font>
<h3> Priest Name - Pt.Harishankar Prasad   
Contact number - 7879648555
 </h3>
<h3>Special Pooja - <br/>
1)Navgrah Pooja &nbsp;&nbsp;&nbsp;<spring:url value="/temple/booknow" var="booknowURL" />
				<a href="${booknowURL}" role="button"><font color="#8E44AD">Book Now </font></a>
<br>
2)ShivaLinga Abhishek &nbsp;&nbsp;&nbsp;<spring:url value="/temple/booknow" var="booknowURL" />
				<a href="${booknowURL}" role="button"><font color="#8E44AD">Book Now </font></a>
<br> 
</h3>
